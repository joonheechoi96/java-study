...
public class StringBuilderExample {
	...
	public static void main(String[] args) {
		...
		// 문자열을 이어 붙이거나 수정할 때 보다 효율적이고 성능상 유리
		// 다중 연산 시 메모리 절약 가능
		// StringBuffer 와 완전 동일, 동기화 기능만 제거 (싱글 쓰레드인 경우 성능 향상)
		// 동기화란? 멀티 쓰레드 환경에서 동시에 변경하려고 할 떄 데이터 보호 기능
		//
...
//		StringBuffer sb = new StringBuffer("Java");
		...
		// 현재 StringBuider에 담긴 문자열 내용을 String 객체로 반환
		String result = sb.toString();
		System.out.println(result);
		
		// 정리: 
		// 내부에서 문자열을 저장해서 조작하기 떄문에 변경이 있을 떄 마다 객체를 만들지 않음
