...
public class RandomExample {
	...
	public static void main(String[] args) {
		...
		// 범위 지정(이상, 미만)
		int randInt4 = random.nextInt(1, 10); // 0~9
		int randInt5 = random.nextInt();
		int randInt6 = random.nextInt();
		...
		double randDouble3 = random.nextDouble();
		double randDouble4 = random.nextDouble();
