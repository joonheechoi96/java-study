...
//	- 축구공: 3000원
	public static void main(String[] args) {
		...
		while (iterator.hasNext()) {
			Equipment element = iterator.next(); // 1개의 요소를 읽어옴	
...
//		storage1.retainAll(storage2);
//		Iterator<Equipment> iteratorRetain = storage1.iterator();
//		System.out.println("*** 교집합 ***");
//		while (iteratorRetain.hasNext()) {
//			Equipment element = iteratorRetain.next(); // 1개의 요소를 읽어옴	
//			System.out.println(element);
//		}
//		storage1.removeAll(storage2);
//		Iterator<Equipment> iteratorRemove = storage1.iterator();
//		System.out.println("*** 차집합 ***");
//		while (iteratorRemove.hasNext()) {
//			Equipment element = iteratorRemove.next(); // 1개의 요소를 읽어옴	
//			System.out.println(element);
//		}
//		
//		
