...
//	[{제목=Whiplash, 가수=에스파}, {제목=HAPPY, 가수=DAY6}]
	public static void main(String[] args) {
		...
		Set<Song> song2 = new HashSet<Song>();
		
		song1.add(new Song("APT", "로제"));
		song1.add(new Song("Whiplash", "에스파"));
		song1.add(new Song("POWER", "G-DRAGON"));
		song2.add(new Song("Whiplash", "에스파"));
		song2.add(new Song("HAPPY", "DAY6"));
		song2.add(new Song("HAPPY", "DAY6"));
