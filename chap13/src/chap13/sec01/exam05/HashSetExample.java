...
public class HashSetExample {
	...
	public static void main(String[] args) {
		// Set 특징
		// 수학의 집합과 유사
		// (해시코드 값을 기반으로 저장하기에) 순서 없이 데이터 저장(저장된 요소를 순서대로 꺼낼 수 없음)
...
//		Set<String> set = new HashSet<String>();
		...
		// 객체 추가
		// 추가할 때 마다 중복 확인 (hashCode() 와 equals() 호출) 후 추가함
...
//		System.out.println("교집합: " + class1);
		...
		System.out.println("부분 집합: " + class1);
		System.out.println();
...
//		fruitsList.sort(); // 커스텀 정렬 기준 (Comparator)
