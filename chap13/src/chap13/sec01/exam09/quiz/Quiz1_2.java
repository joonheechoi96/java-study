package chap13.sec01.exam09.quiz;
...
//		Set<Entry<String, Information>> entrySet = map.entrySet();
//		var entryIterator = entrySet.iterator();
//		while(entryIterator.hasNext()) {
//			// 반복해서 Entry 객체를 얻고 키와 값을 얻어냄
//			Entry<String, Information> entry = entryIterator.next();
//			if (entry.getKey().equals("Emma")) {
//				entry.getValue().setPhone("111-111-111");
//				System.out.println("=== " + entry.getKey() + "의 정보 ===");
//				System.out.println("전화번호:" + entry.getValue().getPhone());
//				System.out.println("월급:" + entry.getValue().getSalary());
//			}
//		}
	}
}
